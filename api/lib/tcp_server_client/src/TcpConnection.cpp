...
TcpConnection::TcpConnection(boost::asio::ip::tcp::socket &&socket, Observer &observer, int id)
...
std::shared_ptr<TcpConnection> TcpConnection::create(boost::asio::ip::tcp::socket &&socket, Observer &observer, int id) {
...
void TcpConnection::close() {
    try {
        ...
        std::cerr << "TcpConnection::close() exception: " + static_cast<std::string>(e.what()) + ".\n";
        return;
    }
